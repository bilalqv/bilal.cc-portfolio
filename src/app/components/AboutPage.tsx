        ...
        <div className="grid grid-cols-1 min-[950px]:grid-cols-2 gap-4 justify-evenly max-sm:w-11/12 max-[950px]:w-4/5 mx-auto">
          ...
          <div className=" flex flex-col space-y-4">
            ...
            <div className="bg-[#e4e4e4] dark:bg-[#090909] shadow-lg rounded-lg p-4 border border-[#b4b4b4] dark:border-[#1c1c1c] outline-1">
              ...
              <p className='flex my-2 mr-4' > <span className='mt-1'><a href={LEETCODE_URL} target='_blank'> <SiLeetcode /> </a> </span> <span>: 3-Star, Solved 400+ Problems</span> </p>
              <p className=' flex my-2 mr-4' > <span className='mt-1'><a href={GFG_URL} target='_blank'>  <SiGeeksforgeeks /> </a></span> <span>: Solved 210+ Problems</span> </p>
              <p className=' flex my-2 mr-4' > <span className='mt-1'><a href={HACKERRANK_URL} target='_blank'> <LiaHackerrank /> </a></span> <span>: 5-Star in C++ and SQL</span> </p>
